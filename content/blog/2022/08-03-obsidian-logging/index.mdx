...
<Info>
  <h3>tl;dr</h3>
  <p>Jump to the [Final code](#final-code) </p>
  <p>Jump to the [updated version](#refactored-note-query)</p>
</Info>
...
<Success>
  ...
  <p>
    It's working with JavaScript. For Good Girls, we're so close to the end of Season 4.
    We're going to watch the Season Finale tonight. I bet Season 5 will be very exciting.
    Wait, what? Cancelled? C'mon Netflix pick it up at least to give it some closure!
  </p>
</Success>
