...
<Warning>
  <h2>Gatsby 2 warning</h2>
  <p>
    This was done some time ago and it was Gatsby 2 at the time. I haven't updated my blog
    yet so I'm not sure what if anything would be required.
  </p>
</Warning>
...
<Warning>
  <h3>Code.js is newer!</h3>
  <p>
    All the following is slightly different code because it is from a different codebase.
    I didn't get all the features working in my test project, but in my blog, they
    work&mdash;mostly.
  </p>
</Warning>
