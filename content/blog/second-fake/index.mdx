...
Well, it doesn't like the word spelled R-E-A-L-L-Y as a whole sentence or a **word** apparently. I tried to use it as an example, in quotation marks, but it still
flagged it. I like some of my weasel words I don't want to give them up! Link color testing
