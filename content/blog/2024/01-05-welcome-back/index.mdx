...
<h3>tl;dr</h3>
<ul>
<li>Make sure your GitHub Action has the correct node-version specified!</li>
<li>If it says 14.x and node.js is on 22.x, chances are, there will be issues at some point.</li>
</ul>
</Info>
