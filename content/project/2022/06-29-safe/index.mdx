...
_Safe_ was the first song I wrote that I felt proud of. I wrote tunes that just never went
anywhere before. This one seemed to go where I wanted it to go!
...
![piano figure in 7/8](safe-piano-groove.png)
...
<p>
  <MarkdownLink href='/charts/safe-c.pdf'>{'Download PDF - C version'}</MarkdownLink>
</p>
<p>
  <MarkdownLink href='/charts/safe-bflat.pdf'>
    {'Download PDF - B'}
    <Flat />
    {' version'}
  </MarkdownLink>
...
<p>
  <MarkdownLink href='/charts/safe-eflat.pdf'>
    {'Download PDF - E'}
    <Flat />
    {' version'}
  </MarkdownLink>
...
<p>
  <MarkdownLink href='/charts/safe-rhythm.pdf'>
...
Replaced `abc` block with image. Sorry for those of you in dark mode.
