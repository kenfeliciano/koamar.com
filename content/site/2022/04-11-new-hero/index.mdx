...
<Warning>This implementation happened in Gatsby 2 days.</Warning>
...
<Warning>
  During the upgrade to Gatsby 4, I removed the Image component. It is much easier to just
  create a static image component on the page that is using it with Gatsby 4. Jump to
  [Static Image Component](#static-image-component) to view this.
</Warning>
