...
<Info>
  I had to rollback @mdx-js/mdx and @mdx-js/react because gatsby-plugin-mdx requires v1 of
  those.
</Info>
...
<Danger>
  Can't resolve 'react-is' in
  '/home/runner/work/koamar.com/koamar.com/node_modules/styled-components/dist'
</Danger>
...
<Info>
  ...
  <p>
    This all worked locally. I of course tested in `gatsby develop` but also with `gatsby
    build`. I never saw an error related to `styled-components`!
  </p>
</Info>
