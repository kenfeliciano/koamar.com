...
_This one didn't go as planned!_ Jump to the end (Decisions, Decisions) to see the sordid details!
...
- Install and configure [mdx support](#mdx-support-for-gatsby) for Gatsby
