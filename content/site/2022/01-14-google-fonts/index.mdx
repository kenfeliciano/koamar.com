...
<Warning>
  ...
  Gatsby 2. It is also using the original gatsby-plugin-google-fonts method and not the
  Google Fonts v2 API.
</Warning>
...
<Info>
  <h3>First Time?</h3>
  <p>
    This is the first time I ever saw these weights for fonts. Hence, I wrote them all out
    so I would remember them. I came across them later, and yes, I did remember them!
  </p>
</Info>
...
<Warning>
  <h3>One final warning</h3>
  <p>
    Yes, I like ligatures. I hear, and even get, the argument for not using them but I
    think they just look nice and I feel happy seeing them.
  </p>
</Warning>
