...
<Info>
  <h3>Keeping it DRY-er</h3>
  <p>
    This had the added benefit of removing some code duplication! When working through the
    Skillthrive tutorial, [Gatsby JS: Build a
    Blog](https://www.youtube.com/playlist?list=PLW0RabRDhwwzVNhlOgQQgw6HJzXdM1MnT), I
    ended up with duplicate code in `gatsby-ssr.js` and `gatsby-browser.js`. Using the App
    component in those two files allows the code to live only in one place.
  </p>
</Info>
...
<Primary>
<h3>First game against the dreaded LA Kings tomorrow!</h3>
<p>
...
<ul>
<li>Sharks are 4-5-1 (next to last place in the West)</li>
<li>Kings are 3-6-2 (last place in the West)</li>
</ul>
</Primary>
